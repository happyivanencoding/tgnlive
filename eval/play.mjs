...
const personaGoals = {
  progression: '你想从凡身逐渐获得属于自己的优势，而不是一直替陌生人逃亡。根据实际情境找机会脱身、交易或取得报酬；当安全允许时，主动练习已经明确拥有的能力或寻求基础修炼指导，观察改善与限制。至少尝试一次合理训练、一次自主改换路线，并在后面使用或核对先前获得的具体物品/约定。不要凭空声称学会秘籍，也不要要求系统直接送等级。具体行动由你根据每回合的真实观察决定。',
